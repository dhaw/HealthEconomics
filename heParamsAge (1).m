function [h,mu,g4]=heParamsAge%(tab)
%Then hard code outputs into prep file!
%%
%Work in row vectors
lx=64;
nn=[3463,3726,3538,3260,3693,4022,4011,3926,3586,3919,4129,3890,3308,2982,2960,2069,1531+933+414+117+12];%ONS 2019
...
%%
%ILI given infection:
pili=[0.467,0.467,0.485,0.485,0.550,0.550,0.601,0.601,0.639,0.639,0.757,0.757,0.860,0.860,0.958,0.958,1.000];
pili=accumarray(subs',pili'.*nnprop');
%Hosp given ILI:
