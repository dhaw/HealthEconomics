...
[pr,NN,n,nbar,na,NNbar,NNrep,Din,beta]=hePrepCovid19(NNsector,data10);
%%
%
...
lb=zeros(lx,1);
ub=ones(lx,1);
X0=repmat(data10.xmin',numInt,1);%zeros(lx,1);
%}
%%
fun1=@(Xit)econGDP(objFun,Xit);
%fun2=@(Xit)econConstraint(Z,Xit);
nonlcon=@(Xit)epiConstraint(pr,n,nbar,na,NN,NNbar,NNrep,Din,beta,Xit,tvec,hospThresh,data10);
